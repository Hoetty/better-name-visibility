...
[![CurseForge](https://cf.way2muchnoise.eu/full_662186_downloads.svg)](https://www.curseforge.com/minecraft/mc-mods/better-name-visibility)
...
![Comparison Image with a barely visible and a good visible name](docs/images/comparison.png)
...
![A name tag in orange color](docs/images/textcolor.png)

### Background Color

Controls the background color of name tags. *It defaults to semi transparent black.*
![A name tag with a bright pink background](docs/images/backgroundcolor.png)
...
![A name underwater. Compares on vs off. On is brighter](docs/images/fullbright.png)
...
![A vertical comparison of two different scale factors](docs/images/namescale.png)
